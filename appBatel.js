...
///////////////////////////////////////////////////////////////////
const HeraImg = document.getElementById('HeraImg');
const HadesImg = document.getElementById('HadesImg');
const ZeusImg = document.getElementById('ZeusImg');
const Hera = document.getElementById('Hera');
const Hades = document.getElementById('Hades');
const Zeus = document.getElementById('Zeus');
HeraImg.addEventListener('click', function(){
    Hera.hidden = true;
    Hades.hidden = false;
});
HadesImg.addEventListener('click', function(){
    Hades.hidden = true;
    Zeus.hidden = false;
});
ZeusImg.addEventListener('click', function(){
    Zeus.hidden = true;
